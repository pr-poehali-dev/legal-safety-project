        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: 'Anchor', title: 'Морские споры', desc: 'Разрешение споров, связанных с морскими перевозками, фрахтом, страхованием грузов и морскими происшествиями.' },
            ...
            {[
              {
                ...
                a: 'Стоимость консультации зависит от сложности вопроса и формата работы. Первичная консультация до 60 минут — 5 000 рублей. Развёрнутая консультация с анализом документов зависит от объема представленных на анализ документов — оплачивается по договоренности. Стоимость комплексного сопровождения обсуждается индивидуально. Онлайн консультации оказываются по предварительной предоплате.'
              },
              {
                q: 'Как быстро я получу ответ на свой вопрос?',
                a: 'Если вы обращаетесь в рабочее время (пн-пт, 10:00-16:00 по времени Владивостока), я отвечу в течение часа во время консультации в заранее оговоренное время встречи. Для сложных вопросов, требующих изучения документов — во время консультации по предварительной договоренности.'
              },
              {
                q: 'Нужно ли приезжать в офис для консультации?',
                a: 'Нет, личный визит не обязателен. Консультации проводятся онлайн через удобные вам мессенджеры (Telegram, WhatsApp). Однако если вам комфортнее встретиться лично — добро пожаловать в офис: г.Владивосток, ул. Петра Великого 2, оф. 400 Адвокатское бюро "Правовая Конструкция".'
              },
              {
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-primary-foreground/80 font-body">Пн-Пт: 10:00-16:00 (UTC+10)</p>
              </div>
            </div>
          </div>
        </div>
