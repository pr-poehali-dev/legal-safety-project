...
const Index = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: 'Алена свяжется с вами в ближайшее время.',
    });
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              <div className="flex justify-center md:justify-start">
                <Badge className="bg-accent/20 text-accent border-accent/30 font-body text-2xl px-6 py-3">30 лет опыта</Badge>
              </div>
            ...
            <div className="relative animate-scale-in">
              ...
              <img
                src="https://cdn.poehali.dev/projects/fd6b7b8a-e698-416b-a0ce-c6273f53e3e5/files/0fa4bfbc-3094-413f-af4b-1b136a9232a9.jpg"
            ...
            {[
              {
                ...
                text: 'Обратился с серьёзным корпоративным спором — партнёр пытался вывести активы компании. Алена быстро разобралась, собрала доказательства и помогла решить вопрос досудебно. Профессионально, быстро, по делу.',
              ...
              },
              {
                ...
                text: 'Столкнулся с незаконными действиями контролирующих органов — пытались закрыть ресторан. Алена оперативно подготовила возражения, представляла в суде. Решение в нашу пользу.',
                result: 'Отменено предписание, ресторан продолжил работу'
              },
              {
                author: 'Елена Т.',
                position: 'Фрилансер, дизайнер',
                text: 'Заказчик отказался платить за выполненную работу. Алена помогла составить претензию, провела переговоры, и мы получили деньги без суда. Теперь все договоры оформляю после консультации.',
